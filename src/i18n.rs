...
static EN: Strings = Strings {
    ...
    halfblock_note: "Half block paints two colors per cell where the two halves differ; needs a color-capable terminal.",
...
static ZH: Strings = Strings {
    ...
    halfblock_note: "半方块在上下两半颜色不同时每格绘制两种颜色，需要终端支持背景色。",
    icon_style: "图标样式",
